...
api_key = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJjbHVlIjoiNjc5MGI4OTE4YTIzODE2NDA3MzhjOTM3IiwiaWF0IjoxNzM3NjQyNDk5LCJleHAiOjMzMjQyMTA2NDk5fQ.de57rVtxcbpX0QA4Dky0uGPqLuc3YCfdv_lCEA6Ls-Q"
...
with params_col:
    with st.form(key='params_form'):
        ...
        exchanges = ['binance', 'bitstamp', 'binancefutures', 'whitebit', 'bybit', 'gatetio', 'coinbase', 'binanceus',
                     'kraken']
        ...
        if st.session_state.symbols_list == None:
            symbols = []
            for i in exchanges:
                symbols_list = requests.get(
                    f'https://api.taapi.io/exchange-symbols?secret={api_key}&exchange={i}').json()
        ...
        with interval_col:
            interval = st.selectbox('Interval', ['1m', '5m', '15m', '30m', '1h', '2h', '4h', '12h', '1d'],
